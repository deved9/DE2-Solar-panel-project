...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define TIM2_ovf_16u() TCCR2B &= ~((1<<CS22) | (1<<CS21)); TCCR2B |= (1<<CS20);

/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM2_ovf_128u() TCCR2B &= ~((1<<CS22) | (1<<CS20)); TCCR2B |= (1<<CS21);

/** @brief Set overflow 262ms, prescaler 011 --> 32 */
#define TIM2_ovf_512u() TCCR2B &= ~(1<<CS22); TCCR2B |= (1<<CS21) | (1<<CS20);
...
#define TIM2_ovf_4ms() TCCR2B &= ~(1<<CS20); TCCR1B |= (1<<CS22) | (1<<CS21);
